...
modelo2 <- lm(mm ~ global_score + sexo + idade + imc + n_comor_classe, df_ajustada)
...
```{r}
# REGRESSÃO AJUSTADA - sexo, idade, IMC
modelo4 <- lm(mm_imc ~ global_score + sexo + idade + imc + n_comor_classe, df_ajustada)
...
```{r}
# REGRESSÃO AJUSTADA - sexo, idade, IMC
modelo6 <- lm(hg ~ global_score  + sexo + idade + imc + n_comor_classe, df_ajustada)
...
```{r}
# REGRESSÃO AJUSTADA - sexo, idade, IMC
modelo10 <- lm(sf_fisico ~ global_score + sexo + idade + imc + n_comor_classe + antidepressivo, df_ajustada)
...
```{r}
# REGRESSÃO AJUSTADA - sexo, idade, IMC
modelo12 <- lm(sf_mental ~ global_score  + sexo + idade + imc + n_comor_classe, df_ajustada)
